...
class HipJointV1(object):
    ...
    def initialize(self):
        ...
        """
        model = Sequential()
        model.add(Dense(32, input_dim=self.input_size))
        model.add(Activation('relu'))
        model.add(Dense(32, input_shape=(self.input_size,)))
        model.add(Activation('relu'))
        model.add(Dense(10))
    ...
    def fit_model(self, model, data, labels):
...
if __name__ == "__main__":
    ...
    ## 4. Fit
    hv1.fit_model(model, fit_data, fit_labels)
